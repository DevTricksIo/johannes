...
export class QuickMenuBuilder {
    ...
    static build(): QuickMenu {
        ...
        basicBlocksSection.appendQuickMenuItems([
            ...
            new QuickMenuItem(basicBlocksSection, 'Heading 2', 'Medium header for subsections.', 'icon-julia-head-2', ElementFactoryService.ELEMENT_TYPES.HEADER_2, "header 2 heading 2 h2"),
            new QuickMenuItem(basicBlocksSection, 'Heading 3', 'Small header for detailed sections.', 'icon-julia-head-2', ElementFactoryService.ELEMENT_TYPES.HEADER_3, "header 3 heading 3 h3"),
        ...
        headingBlocksSection.appendQuickMenuItems([
            ...
            new QuickMenuItem(headingBlocksSection, 'Heading 5', 'Small header for detailed sections.', 'icon-julia-head-5', ElementFactoryService.ELEMENT_TYPES.HEADER_5, "header 5 heading 5 h5"),
            new QuickMenuItem(headingBlocksSection, 'Heading 6', 'Small header for detailed sections.', 'icon-julia-head-6', ElementFactoryService.ELEMENT_TYPES.HEADER_6, "header 6 heading 6 h6"),
        ]);
