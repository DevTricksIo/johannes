...
class QuickMenuBuilder {
    ...
    static build(blockOperationsService: IBlockOperationsService): QuickMenu {
        ...
        basicBlocksSection.appendQuickMenuItems([
            new QuickMenuItem(basicBlocksSection, 'Paragraph', 'Just start writing with plain text.', 'icon-wordpress-paragraph', ELEMENT_TYPES.PARAGRAPH),
            ...
            new QuickMenuItem(basicBlocksSection, 'Heading 2', 'Medium header for subsections.', 'icon-julia-head-2', ELEMENT_TYPES.HEADER_2),
            new QuickMenuItem(basicBlocksSection, 'Heading 3', 'Small header for detailed sections.', 'icon-julia-head-2', ELEMENT_TYPES.HEADER_3),
        ...
        headingBlocksSection.appendQuickMenuItems([
            new QuickMenuItem(headingBlocksSection, 'Heading 1', 'Large header to organize content.', 'icon-julia-head-1', ELEMENT_TYPES.BLOCK_HEADER_1),
            new QuickMenuItem(headingBlocksSection, 'Heading 2', 'Medium header for subsections.', 'icon-julia-head-2', ELEMENT_TYPES.HEADER_2),
            new QuickMenuItem(headingBlocksSection, 'Heading 3', 'Small header for detailed sections.', 'icon-julia-head-3', ELEMENT_TYPES.HEADER_3),
            new QuickMenuItem(headingBlocksSection, 'Heading 4', 'Small header for detailed sections.', 'icon-julia-head-4', ELEMENT_TYPES.HEADER_4),
            new QuickMenuItem(headingBlocksSection, 'Heading 5', 'Small header for detailed sections.', 'icon-julia-head-5', ELEMENT_TYPES.HEADER_5),
            new QuickMenuItem(headingBlocksSection, 'Heading 6', 'Small header for detailed sections.', 'icon-julia-head-6', ELEMENT_TYPES.HEADER_6),
        ]);
