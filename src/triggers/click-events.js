...
import { isShowingTextFormattingBar } from '../components/text-formatting-bar/text-formatting-bar';
import { canHideTextFormattingBar } from '../components/text-formatting-bar/text-formatting-bar';
import { isOutOfTextFormattingBar } from '../components/text-formatting-bar/text-formatting-bar';
